<div class="scrollbar side-menu-bg" style="overflow: scroll">
    <ul class="nav navbar-nav side-menu" id="sidebarnav">
        ...
        <!-- الاقسام-->
        <li>
            <a href="{{ route('section') }}"><i class="fa fa-window-maximize"></i><span
                    class="right-nav-text">الاقسام</span></a>
        </li>

        <!-- الطلاب-->
        <li>
            <a href="{{ route('student.index') }}"><i class="ti-user"></i><span class="right-nav-text">الطلاب</span></a>
        </li>
        ...
        <li>
            <a href="javascript:void(0);" data-toggle="collapse" data-target="#quizzes-menu">
                <div class="pull-left"><i class="fa fa-wpforms"></i>
        ...
        <li>
            <a href="javascript:void(0);" data-toggle="collapse" data-target="#sections-menu">
                <div class="pull-left"><i class="fa fa-calendar"></i><span class="right-nav-text">التقارير</span>
                </div>
                <div class="pull-right"><i class="ti-plus"></i></div>
                <div class="clearfix"></div>
            </a>
        ...
        <li>
            ...
            <ul id="Onlineclasses-icon" class="collapse" data-parent="#sidebarnav">
                <li> <a href="{{ route('online_class.index') }}">حصص اونلاين مع زوم</a> </li>
            </ul>
        </li>
        <!-- الملف الشخصي-->
        <li>
            <a href="{{ route('profile.show') }}"><i class="fa fa-address-book-o"></i><span
