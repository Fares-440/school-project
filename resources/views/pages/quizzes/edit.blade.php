                        ...
                        <form action="{{ route('quizzes.update', 'test') }}" method="post">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col">
                                    ...
                                    <input type="text" name="name[ar]" value="{{ $quizz->getTranslation('name', 'ar') }}"
                                        class="form-control">
                                ...
                                <div class="col">
                                    ...
                                    <input type="text" name="name[en]" value="{{ $quizz->getTranslation('name', 'en') }}"
                                        class="form-control">
                                </div>
                            </div>
                            <br>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        <label for="teacher_id">اسم المعلم : <span
                                                class="text-danger">*</span></label>
