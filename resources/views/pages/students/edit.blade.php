                                ...
                                <select class="custom-select mr-sm-2" name="gender_id">
                                    ...
                                    @foreach ($genders as $gender)
                                        <option value="{{ $gender->id }}"
                                            {{ $gender->id == $student->gender->id ? 'selected' : '' }}>
                                            {{ $gender->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="custom-select mr-sm-2" name="nationalitie_id">
                                    ...
                                    @foreach ($nationalities as $nal)
                                        <option value="{{ $nal->id }}"
                                            {{ $nal->id == $student->nationalitie->id ? 'selected' : '' }}>
                                            {{ $nal->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="custom-select mr-sm-2" name="blood_id">
                                    ...
                                    @foreach ($bloods as $bg)
                                        <option value="{{ $bg->id }}"
                                            {{ $bg->id == $student->blood->id ? 'selected' : '' }}>
                                            {{ $bg->name }}
                                        </option>
                                    @endforeach
                                </select>
                                ...
                                <select class="custom-select mr-sm-2" name="grade_id">
                                    ...
                                    @foreach ($grades as $grade)
                                        <option value="{{ $grade->id }}"
                                            {{ $grade->id == $student->grade->id ? 'selected' : '' }}>
                                            {{ $grade->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <select class="custom-select mr-sm-2" name="classroom_id">
                                    <option value="{{ $student->classroom->id }}">{{ $student->classroom->name }}
                                    </option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <select class="custom-select mr-sm-2" name="section_id">
                                    <option value="{{ $student->section->id }}"> {{ $student->section->name }}
                                    </option>
                                </select>
                            </div>
                        </div>
                                ...
                                <select class="custom-select mr-sm-2" name="parent_id">
                                    ...
                                    @foreach ($parents as $parent)
                                        <option value="{{ $parent->id }}"
                                            {{ $parent->id == $student->parent->id ? 'selected' : '' }}>
