                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input  class="form-control" name="debit" value="{{old('debit',$receipt_student->debit)}}" type="number" >
                                        <input  type="hidden" name="student_id" value="{{old('student_id',$receipt_student->student->id)}}" class="form-control">
                                        <input  type="hidden" name="id"  value="{{old('id',$receipt_student->id)}}" class="form-control">
                                    </div>
                                </div>
                            </div>
