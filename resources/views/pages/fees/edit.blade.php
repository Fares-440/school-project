                ...
                <form action="{{ route('fees.update', 'test') }}" method="post" autocomplete="off">
                    ...
                    <div class="form-row">
                        <div class="form-group col">
                            ...
                            <input type="text" value="{{ $fee->getTranslation('title', 'ar') }}" name="title[ar]"
                                class="form-control">
                        ...
                        <div class="form-group col">
                            ...
                            <input type="text" value="{{ $fee->getTranslation('title', 'en') }}" name="title[en]"
                                class="form-control">
                        </div>
                        ...
                        <div class="form-group col">
                            ...
                            <input type="text" value="{{ $fee->fee_type == 1 ? 'رسوم دراسية' : 'رسوم باص' }}"
                                readonly class="form-control">
                            <input type="hidden" value="{{ $fee->fee_type == 1 ? 1 : 2 }}"
                                name="fee_type" readonly class="form-control">
                        </div>
