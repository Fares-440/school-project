                                ...
                                <div class="form-group col">
                                    ...
                                    <select class="custom-select my-1 mr-sm-2" name="specialization_id">
                                        ...
                                        @foreach ($specializations as $specialization)
                                            <option value="{{ $specialization->id }}" {{old('specialization_id') == $specialization->id ? 'selected': "" }}>{{ $specialization->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col">
                                    ...
                                    <div class='input-group date'>
                                        <input class="form-control" type="text" id="datepicker-action"
                                            name="joining_date" data-date-format="yyyy-mm-dd" value="{{old('joining_date')}}" >
                                    </div>
                                    @error('joining_date')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
